...
def show_graph_page():
    ...
    # alcohol_selection = st.slider(
    #     "Alcohol content: ",
    #     min_value=min(alcohol),
    #     max_value=max(alcohol),
    #     value=(min(alcohol), max(alcohol)),
    # )
    ...
    # sulphate_selection = st.slider(
    #     "Sulphates content: ",
    #     min_value=min(sulphates),
    #     max_value=max(sulphates),
    #     value=(min(sulphates), max(sulphates)),
    # )
    # # alcohol_selection = st.multiselect("Alcohol: ", alcohol, default=alcohol)
    ...
    #     y="sulphates",
    #     text="sulphates",
    #     color_discrete_sequence=["#F63366"] * len(grouped2),
    #     template="plotly_white",
    # )
    ...
    # pie_chart = px.pie(
    #     tab,
    #     title="Dependence of quality on alcohol content",
    #     values="alcohol2",
    #     names="quality",
    # )
